...
class ProbabilityCalculator:
    ...
    def populate_scrollable_pane(self):
        ...
        query = "SELECT `n(S)`, `n(A)`, `n(B)`, `Simple_P`, `Complementary_P`, `Conditional_P`, `Addition_R`, `Multiplication_R` FROM probability_history"
...
class CombinatoricsCalculator:
    ...
    def populate_scrollable_pane(self):
        ...
        query = "SELECT `(n)`, `(r)`, `Factorial_R`, `Permutation_R`, `Combination_R` FROM combinatronics_history"
        self.db_cursor.execute(query)
        rows = self.db_cursor.fetchall()
